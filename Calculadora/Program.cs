...
namespace Calculadora_Basica
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Digite a operação matemática desejada e aperte enter: ( /= divisão , * = multiplicação, + = soma, - = subtração e % = MOD resto ): ");
            operador = Console.ReadLine();

           

            Console.WriteLine("Digite o segundo valor e aperte enter: ");
            valorDigitado = Console.ReadLine();
            numero_inteiro = double.TryParse(valorDigitado, out numero);
            if (numero_inteiro)
            {
